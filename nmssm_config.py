...
def build_config(
    ...
    # overwrite delta R threshold for pair selection in mm scope to cover "boosted" as well as "non-boosted" tau proxies
    configuration.add_config_parameters(
        ["mm"],
        {
    ...
    configuration.add_modification_rule(
        ["mm"],
        ReplaceProducer(
            producers=[fatjets.BasicFatJetQuantities, fatjets.BasicFatJetQuantitiesMuMu],
            samples=available_sample_types,
        ),
    )
    configuration.add_modification_rule(
        ["mm"],
        ReplaceProducer(
            producers=[jets.BasicJetQuantities, jets.BasicJetQuantitiesMuMu],
            samples=available_sample_types,
        ),
    )
    configuration.add_modification_rule(
